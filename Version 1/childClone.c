 ...
 * The children read and write the files and the parent displays it.
 * =====================================================================================
 ...
 * gcc -Wall childClone.c -o childClone
 * ./childClone /Users/gabe/Desktop/Test/Data/Images /Users/gabe/Desktop/Test/Data/Patterns
 * -------------------------------------------------------------------------------------
 */
#include <stdio.h>
#include <stdlib.h>
